...
def mean_bilateral(image, footprint, out=..., mask=..., shift_x=..., shift_y=..., s0=..., s1=...):
...
def pop_bilateral(image, footprint, out=..., mask=..., shift_x=..., shift_y=..., s0=..., s1=...):
...
def sum_bilateral(image, footprint, out=..., mask=..., shift_x=..., shift_y=..., s0=..., s1=...):
    """Apply a flat kernel bilateral filter.
