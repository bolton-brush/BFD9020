...
def try_all_threshold(image, figsize=..., verbose=...) -> tuple[Any, Any]:
...
def threshold_local(image, block_size=..., method=..., offset=..., mode=..., param=..., cval=...) -> ndarray[tuple[int], _dtype]:
...
def threshold_otsu(image=..., nbins=..., *, hist=...):
...
def threshold_yen(image=..., nbins=..., *, hist=...):
...
def threshold_isodata(image=..., nbins=..., return_all=..., *, hist=...):
...
_DEFAULT_ENTROPY_BINS = ...
def threshold_li(image, *, tolerance=..., initial_guess=..., iter_callback=...) -> float | Any:
...
def threshold_minimum(image=..., nbins=..., max_num_iter=..., *, hist=...):
...
def threshold_triangle(image, nbins=...):
...
def threshold_niblack(image, window_size=..., k=...):
...
def threshold_sauvola(image, window_size=..., k=..., r=...):
...
def apply_hysteresis_threshold(image, low, high) -> Any | ndarray[_AnyShape, dtype[bool_]]:
...
def threshold_multiotsu(image=..., classes=..., nbins=..., *, hist=...):
