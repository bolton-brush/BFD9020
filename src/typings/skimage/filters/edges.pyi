...
farid_smooth = np.array([[0.0376593171958126, 0.249153396177344, 0.426374573253687, 0.249153396177344, 0.0376593171958126]])
farid_edge = np.array([[0.109603762960254, 0.276690988455557, 0, -0.276690988455557, -0.109603762960254]])
HFARID_WEIGHTS = farid_edge.T * farid_smooth
VFARID_WEIGHTS = np.copy(HFARID_WEIGHTS.T)
def sobel(image, mask=..., *, axis=..., mode=..., cval=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def sobel_h(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def sobel_v(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def scharr(image, mask=..., *, axis=..., mode=..., cval=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def scharr_h(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def scharr_v(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def prewitt(image, mask=..., *, axis=..., mode=..., cval=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def prewitt_h(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def prewitt_v(image, mask=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def roberts_pos_diag(image, mask=...) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any]:
...
def roberts_neg_diag(image, mask=...) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any]:
...
def laplace(image, ksize=..., mask=...) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any]:
...
def farid(image, mask=..., *, axis=..., mode=..., cval=...) -> Any | NDArray[float64] | ndarray[Any | _AnyShape | tuple[int], dtype[bool_]]:
...
def farid_h(image, *, mask=...) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any]:
...
def farid_v(image, *, mask=...) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any]:
