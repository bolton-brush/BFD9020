...
"""
def graycomatrix(image, distances, angles, levels=..., symmetric=..., normed=...) -> ndarray[tuple[Any | Literal[256], Any | Literal[256], int, int], _dtype] | ndarray[_AnyShape, _dtype] | NDArray[unsignedinteger[Any]] | _Array[tuple[Any | Literal[256], Any | Literal[256], int, int], unsignedinteger[_32Bit]]:
...
def graycoprops(P, prop=...) -> Any | _Array[tuple[Any, Any], float64]:
...
def draw_multiblock_lbp(image, r, c, width, height, lbp_code=..., color_greater_block=..., color_less_block=..., alpha=...) -> ndarray[Any, Any] | NDArray[bool_] | ndarray[Any, _dtype] | ndarray[_AnyShape, _dtype] | ndarray[tuple[int], _dtype] | _Array[Any | tuple[int], Incomplete]:
