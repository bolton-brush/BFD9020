...
def daisy(image, step=..., radius=..., rings=..., histograms=..., orientations=..., normalization=..., sigmas=..., ring_radii=..., visualize=...) -> tuple[NDArray[floating[Any]] | ndarray[_AnyShape, dtype[bool_]], NDArray[Any]] | NDArray[floating[Any]] | ndarray[_AnyShape, dtype[bool_]]:
