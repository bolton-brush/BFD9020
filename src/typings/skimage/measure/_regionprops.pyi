...
def only2d(method) -> _Wrapped[..., Any, ..., Any]:
    ...
...
class RegionProperties:
    ...
    """
    def __init__(self, slice, label, label_image, intensity_image, cache_active, *, extra_properties=..., spacing=..., offset=...) -> None:
        ...
    
    def __getattr__(self, attr) -> Any | NDArray[Any]:
        ...
    ...
    @property
    @_cached
    def image_convex(self) -> _Array1D[Incomplete]:
        ...
    
    @property
    def coords_scaled(self) -> NDArray[intp]:
        ...
    
    @property
    def coords(self) -> NDArray[intp]:
        ...
    
    @property
    @only2d
    def eccentricity(self) -> float | Literal[0]:
        ...
    ...
    @property
    def euler_number(self) -> NDArray[signedinteger[Any]] | NDArray[intp] | int:
        ...
    ...
    @property
    @_cached
    def image_filled(self) -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | ndarray[Any, Any] | None:
        ...
    ...
    @property
    @_cached
    def inertia_tensor(self) -> _Array[tuple[Any, Any], float64]:
        ...
    
    @property
    @_cached
    def inertia_tensor_eigvals(self) -> list[Any]:
        ...
    ...
    @property
    def centroid_local(self) -> _Array1D[numpy.bool[builtins.bool]]:
        ...
    ...
    @property
    def intensity_mean(self) -> NDArray[float64]:
        ...
    
    @property
    def intensity_median(self) -> NDArray[Any]:
        ...
    ...
    @property
    def intensity_std(self) -> NDArray[float64]:
        ...
    ...
    @property
    @only2d
    def perimeter_crofton(self) -> Any:
        ...
    ...
    @property
    def centroid_weighted(self) -> tuple[Any, ...]:
        ...
    
    @property
    def centroid_weighted_local(self) -> NDArray[float64]:
        ...
    
    @property
    @_cached
    def moments_weighted(self) -> NDArray[Any] | Any:
        ...
    
    @property
    @_cached
    def moments_weighted_central(self) -> NDArray[Any] | Any:
        ...
    
    @property
    @only2d
    def moments_weighted_hu(self) -> NDArray[Any]:
        ...
    
    @property
    @_cached
    def moments_weighted_normalized(self) -> NDArray[Any]:
        ...
...
def regionprops_table(label_image, intensity_image=..., properties=..., *, cache=..., separator=..., extra_properties=..., spacing=...) -> dict[Any, Any]:
...
def regionprops(label_image, intensity_image=..., cache=..., *, extra_properties=..., spacing=..., offset=...) -> list[Any]:
