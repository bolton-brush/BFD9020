...
def pearson_corr_coeff(image0, image1, mask=...) -> tuple[float, ...]:
...
def manders_coloc_coeff(image0, image1_mask, mask=...) -> Literal[0]:
...
def manders_overlap_coeff(image0, image1, mask=...) -> Any:
...
def intersection_coeff(image0_mask, image1_mask, mask=...) -> float64 | Literal[0]:
