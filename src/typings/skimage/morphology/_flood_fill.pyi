...
"""
def flood_fill(image, seed_point, new_value, *, footprint=..., connectivity=..., tolerance=..., in_place=...):
...
def flood(image, seed_point, *, footprint=..., connectivity=..., tolerance=...) -> _Array1D[Incomplete] | ndarray[_AnyShape, _dtype]:
