...
"""
@default_footprint
@deprecate_func(deprecated_version="0.26", removed_version="0.28", hint="Use `skimage.morphology.erosion` instead. " "Note the pixel shift by 1 for even-sized footprints (see docstring notes).")
def binary_erosion(image, footprint=..., out=..., *, mode=...) -> _Array1D[Incomplete]:
...
@default_footprint
@deprecate_func(deprecated_version="0.26", removed_version="0.28", hint="Use `skimage.morphology.dilation` instead. " "Note the lack of mirroring for non-symmetric footprints (see docstring notes).")
def binary_dilation(image, footprint=..., out=..., *, mode=...) -> _Array1D[Incomplete]:
...
@default_footprint
@deprecate_func(deprecated_version="0.26", removed_version="0.28", hint="Use `skimage.morphology.opening` instead.")
def binary_opening(image, footprint=..., out=..., *, mode=...):
...
@default_footprint
@deprecate_func(deprecated_version="0.26", removed_version="0.28", hint="Use `skimage.morphology.closing` instead.")
def binary_closing(image, footprint=..., out=..., *, mode=...):
