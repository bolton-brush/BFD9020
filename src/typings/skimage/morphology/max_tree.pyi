...
signed_int_types = ...
signed_float_types = ...
def max_tree(image, connectivity=...) -> tuple[_Array1D[signedinteger[_64Bit]], ndarray[Any, _dtype]]:
...
def area_opening(image, area_threshold=..., connectivity=..., parent=..., tree_traverser=...):
...
def diameter_opening(image, diameter_threshold=..., connectivity=..., parent=..., tree_traverser=...):
...
def area_closing(image, area_threshold=..., connectivity=..., parent=..., tree_traverser=...) -> Any:
...
def diameter_closing(image, diameter_threshold=..., connectivity=..., parent=..., tree_traverser=...) -> Any:
...
def max_tree_local_maxima(image, connectivity=..., parent=..., tree_traverser=...) -> _Array1D[unsignedinteger[_64Bit]]:
