...
def chan_vese(image, mu=..., lambda1=..., lambda2=..., tol=..., max_num_iter=..., dt=..., init_level_set=..., extended_output=...) -> tuple[NDArray[bool_] | Any, ndarray[_AnyShape, dtype[Any]] | Any, list[Any]] | NDArray[bool_]:
