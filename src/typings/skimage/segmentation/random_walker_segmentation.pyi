...
def random_walker(data, labels, beta=..., mode=..., tol=..., copy=..., return_full_prob=..., spacing=..., *, prob_tol=..., channel_axis=...) -> NDArray[Any] | NDArray[signedinteger[Any]] | _Array1D[float64]:
