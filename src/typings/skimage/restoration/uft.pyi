...
"""
def ufftn(inarray, dim=...) -> tuple[Dispatchable]:
...
def uifftn(inarray, dim=...) -> tuple[Dispatchable]:
...
def urfftn(inarray, dim=...) -> tuple[Dispatchable]:
...
def uirfftn(inarray, dim=..., shape=...) -> tuple[Dispatchable]:
...
def ufft2(inarray) -> tuple[Dispatchable]:
...
def uifft2(inarray) -> tuple[Dispatchable]:
...
def urfft2(inarray) -> tuple[Dispatchable]:
...
def uirfft2(inarray, shape=...) -> tuple[Dispatchable]:
...
def ir2tf(imp_resp, shape, dim=..., is_real=...):
...
def laplacian(ndim, shape, is_real=...) -> tuple[Any, _Array1D[float64]]:
