...
@deprecate_parameter("num_threads", new_name="workers", start_version="0.26", stop_version="0.28")
def rolling_ball(image, *, radius=..., kernel=..., nansafe=..., num_threads=..., workers=...):
...
def ball_kernel(radius, ndim) -> Any:
